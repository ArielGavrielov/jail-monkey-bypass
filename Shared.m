...
{
	NSMutableDictionary* existingPrefs = [NSDictionary dictionaryWithContentsOfFile:JAIL_MONKEY_BYPASS_PREFS_PATH].mutableCopy;
	if(existingPrefs)
	{
		...
		if(previousVersionEnabled.count)
		{
			...
			[existingPrefs writeToFile:JAIL_MONKEY_BYPASS_PREFS_PATH atomically:YES];
		}
	}
}